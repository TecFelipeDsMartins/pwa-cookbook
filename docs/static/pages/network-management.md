<span class="requirements">Prérequis: lecture des pages <a href="#/pages/optimistic-ui">Compensation de latence</a> et <a href="#/pages/service-workers">Service Workers</a></span>
